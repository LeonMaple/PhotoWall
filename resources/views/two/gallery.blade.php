					 ...
					 <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2">
						<h3>Menu</h3>
						 <ul>
							 ...
							 <li><a href="services"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Services</a></li>
							 <li class="active"><a href="gallery"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span>Gallery</a></li>
		...
		<div class="container">
			...
			<div class="gallery-grids">
				<div class="gallery-grid2">
					<div class="gallery-grid">
						<div class="gallery-grid1">
							<a href="../images/two/5.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
						...
						<div class="gallery-grid1">
							<a href="../images/two/9.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
								<img src="../images/two/9.jpg" alt=" " class="img-responsive" />
								<div class="p-mask">
									<h4>Walk</h4>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit
										amet, consectetur, adipisci velit.</p>
					...
					<div class="gallery-grid-sub">
						<div class="gallery-grid1">
							<a href="../images/two/10.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
								<img src="../images/two/10.jpg" alt=" " class="img-responsive" />
								<div class="p-mask">
									<h4>Walk</h4>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit
										amet, consectetur, adipisci velit.</p>
						...
						<div class="gallery-grid1">
							<a href="../images/two/11.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
								<img src="../images/two/11.jpg" alt=" " class="img-responsive" />
								<div class="p-mask">
									<h4>Walk</h4>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit
										amet, consectetur, adipisci velit.</p>
					...
					<div class="clearfix"> </div>
					<div class="gallery-grid1">
						<a href="../images/two/2.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
				...
				<div class="gallery-grid-sub1">
					<div class="gallery-grid1">
						<a href="../images/two/8.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
					...
					<div class="gallery-grid1">
						<a href="../images/two/12.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
							<img src="../images/two/12.jpg" alt=" " class="img-responsive" />
							<div class="p-mask">
								<h4>Walk</h4>
								<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit
									amet, consectetur, adipisci velit.</p>
					...
					<div class="gallery-grid1">
						<a href="../images/two/13.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
				...
				<div class="clearfix"> </div>
				<!-- script -->
					<script src="../js/two/jquery.chocolat.js"></script>
						<link rel="stylesheet" href="../css/two/chocolat.css" type="text/css" media="screen" charset="utf-8">
						<!--light-box-files-->
