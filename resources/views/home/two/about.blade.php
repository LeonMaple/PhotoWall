...
<div class="about">
    <div class="container">
        <div class="about-grid">
            <img src="../images/two/20.jpg" alt=" " class="img-responsive"/>
        ...
        <div class="about-grid1-grids">
            ...
            <div class="col-md-6 about-grid1-grid">
                <div class="about-grid1">
                    <div class="pro1">
                        <div class="progress pro">
                            <div class="progress-bar pro-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                ...
                <div class="about-grid1">
                    <div class="pro1">
                        <div class="progress pro">
                            <div class="progress-bar pro-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0"
                ...
                <div class="about-grid1">
                    <div class="pro1">
                        <div class="progress pro">
                            <div class="progress-bar pro-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0"
            ...
            <div class="col-md-6 about-grid1-grid">
                <div class="about-grid1">
                    <div class="pro1">
                        <div class="progress pro">
                            <div class="progress-bar pro-bar" role="progressbar" aria-valuenow="40" aria-valuemin="0"
                ...
                <div class="about-grid1">
                    <div class="pro1">
                        <div class="progress pro">
                            <div class="progress-bar pro-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0"
                ...
                <div class="about-grid1">
                    <div class="pro1">
                        <div class="progress pro">
                            <div class="progress-bar pro-bar" role="progressbar" aria-valuenow="20" aria-valuemin="0"
