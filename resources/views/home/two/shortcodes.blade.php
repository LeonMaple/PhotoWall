            ...
            <div class="top-nav">
                <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2">
                    <ul>
                        ...
                        <li class="active"><a href="shortcodes">Short Codes</a></li>
...
<div class="typo">
    <div class="container">
        <div class="typo-grids">
            ...
            <div class="grid_3 grid_5">
                ...
                <div class="col-md-6">
                    ...
                    <div class="list-group list-group-alternate">
                        <a href="#" class="list-group-item"><span class="badge">201</span> <i class="ti ti-email"></i>
                            Inbox </a>
            ...
            <p>For basic stylinglight padding and only horizontal add the base class <code>.table</code> to any <code>&lt;table&gt;</code>.
            </p>
