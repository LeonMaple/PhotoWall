        ...
        <div class="top_section">
            <div class="bnr-btm-left grid">
                <figure class="effect-ming wow fadeInLeft animated animated" data-wow-delay=".5s">
                    <img src="images/one/1.jpg" alt="img09"/>
                    <figcaption>
            ...
            <div class="bnr-btm-right">
                ...
                <p>Lorem Ipsum is simply dummy the when an unknown galley of type and scrambled it to make It was
        ...
        <div class="top_section two">
            ...
            <div class="bnr-btm-left two grid">
                <figure class="effect-ming wow fadeInRight animated animated" data-wow-delay=".5s">
                    <img src="images/one/2.jpg" alt="img09"/>
                    <figcaption>
                        <h3>Bo<span>at</span></h3>
                        <p>Ming sits in the corner the whole day. She's into crochet.</p>
                        <a href="#">View more</a>
            ...
            <div class="modal-body about">
                <div class="about">
                    ...
                    <div class="about-inner">
                        ...
                        <img src="images/one/about.jpg" alt="about"/>
        ...
        <div class="team">
            <div class="col-md-3 staff2">
                <div class="view view-fifth wow fadeInLeft animated animated" data-wow-delay=".5s">
                    <div class="mask1"><img src="images/one/t2.jpg" alt="image" class="img-responsive zoom-img"/></div>
                    <div class="mask">
                        ...
                        <div id="small-dialog2" class="mfp-hide">
                            <div class="pop_up2">
                                <img src="images/one/t2.jpg" class="img-responsive" alt=""/>
                                <h3>About</h3>
            ...
            <div class="col-md-3 staff2">
                <div class="view view-fifth wow fadeInUp animated animated" data-wow-delay=".5s">
                    <div class="mask1"><img src="images/one/t1.jpg" alt="image" class="img-responsive zoom-img"/></div>
                    <div class="mask">
                        ...
                        <div id="small-dialog1" class="mfp-hide">
                            <div class="pop_up2">
                                <img src="images/one/t1.jpg" class="img-responsive" alt=""/>
                                <h3>About</h3>
                                <p class="popup_desc">Mirum est notare quam littera gothica, quam nunc putamus parum
                                    claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et
                                    quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant
            ...
            <div class="col-md-3 staff2">
                <div class="view view-fifth wow fadeInRight animated animated" data-wow-delay=".5s">
                    <div class="mask1"><img src="images/one/t3.jpg" alt="image" class="img-responsive zoom-img"/></div>
                    <div class="mask">
                        ...
                        <div id="small-dialog3" class="mfp-hide">
                            <div class="pop_up2">
                                <img src="images/one/t3.jpg" class="img-responsive" alt=""/>
                                <h3>About</h3>
                                <p class="popup_desc">Mirum est notare quam littera gothica, quam nunc putamus parum
                                    claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et
                                    quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant
            ...
            <div class="col-md-3 staff2">
                <div class="view view-fifth wow fadeInRight animated animated" data-wow-delay=".5s">
                    <div class="mask1"><img src="images/one/t4.jpg" alt="image" class="img-responsive zoom-img"/></div>
                    <div class="mask">
                        <a class="popup-with-zoom-anim" href="#small-dialog3">
                            <div class="info"><i class="glyphicon glyphicon-zoom-in"></i></div>
                        </a>
                        <div id="small-dialog3" class="mfp-hide">
                            <div class="pop_up2">
                                <img src="images/one/t4.jpg" class="img-responsive" alt=""/>
                                <h3>About</h3>
                                <p class="popup_desc">Mirum est notare quam littera gothica, quam nunc putamus parum
                                    claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et
                                    quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant
    ...
    <div class="wrap">
            ...
            <div class="col-md-4 grid slideanim wow fadeInLeft animated animated animated" data-wow-delay=".5s">
                <figure class="effect-jazz">
                    <a href="#portfolioModal1" data-toggle="modal">
                        ...
                        <img src="images/one/p1.jpg" alt="img25" class="img-responsive"/>
                        <figcaption>
                            <h4>Go Easy On</h4>
            ...
            <div class="col-md-4 grid slideanim wow fadeInUp animated animated animated" data-wow-delay=".5s">
                <figure class="effect-jazz">
                    <a href="#portfolioModal2" data-toggle="modal">
                        ...
                        <img src="images/one/p2.jpg" alt="img25" class="img-responsive"/>
                        <figcaption>
                            <h4>Go Easy On</h4>
                            <p> There are many variations of passages of Lorem Ipsum .</p>
                        </figcaption>
            ...
            <div class="col-md-4 grid slideanim wow fadeInRight animated animated" data-wow-delay=".5s">
                <figure class="effect-jazz">
                    <a href="#portfolioModal3" data-toggle="modal">
                        ...
                        <img src="images/one/p3.jpg" alt="img25" class="img-responsive"/>
                        <figcaption>
                            <h4>Go Easy On</h4>
                            <p> There are many variations of passages of Lorem Ipsum .</p>
                        </figcaption>
        ...
        <div class="portfolio-top">
            ...
            <figure class="effect-jazz">
                <a href="#portfolioModal4" data-toggle="modal">
                    ...
                    <img src="images/one/p4.jpg" alt="img25" class="img-responsive"/>
                    <figcaption>
        ...
        <div class="col-md-4 grid grid-wi slideanim wow fadeInUp animated animated animated" data-wow-delay=".5s">
            <figure class="effect-jazz">
                <a href="#portfolioModal5" data-toggle="modal">
                    ...
                    <img src="images/one/p5.jpg" alt="img25" class="img-responsive"/>
                    <figcaption>
                        <h4 class="effcet-text">Go Easy On</h4>
                        <p> There are many variations of passages.</p>
                    </figcaption>
        ...
        <figure class="effect-jazz">
            <a href="#portfolioModal6" data-toggle="modal">
                ...
                <img src="images/one/p6.jpg" alt="img25" class="img-responsive"/>
                <figcaption>
                    <h4 class="effcet-text">Go Easy On</h4>
                    <p> There are many variations of passages.</p>
                </figcaption>
        ...
        <div class="container">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="modal-body">
                    ...
                    <img src="images/one/p1.jpg" class="img-responsive" alt="">
        ...
        <div class="container">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="modal-body">
                    ...
                    <img src="images/one/p2.jpg" class="img-responsive" alt="">
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
                        of type and scrambled it to make a type specimen book.</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="modal-body">
                    ...
                    <img src="images/one/p3.jpg" class="img-responsive" alt="">
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
                        of type and scrambled it to make a type specimen book.</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="modal-body">
                    ...
                    <img src="images/one/p4.jpg" class="img-responsive" alt="">
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
                        of type and scrambled it to make a type specimen book.</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="modal-body">
                    ...
                    <img src="images/one/p5.jpg" class="img-responsive" alt="">
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
                        of type and scrambled it to make a type specimen book.</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="modal-body">
                    ...
                    <img src="images/one/p6.jpg" class="img-responsive" alt="">
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
                        of type and scrambled it to make a type specimen book.</p>
                </div>
...
<div class="bottom-section">
    <div class="wrap">
        ...
        <div class="banner-center">
            ...
            <p class="vd">Lorem ipsum dolor sit amet. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                nisi ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident</p>
            <a href="#" data-toggle="modal" data-target="#myModal2" class="play" href="#"><i
            ...
            <div class="sp-testimonials">
                <div class="sp">
                    <div class="col-md-6 pic wow fadeInLeft animated animated" data-wow-delay=".5s">
                        <blockquote>Health amplify respect cornerstone, affordable health care inspiration. Honor
                            human-centered design rural vulnerable population partner volunteer emergency.
                        </blockquote>
                        <img src="images/one/t4.jpg" alt="">
                    ...
                    <div class="col-md-6 pic wow fadeInRight animated animated" data-wow-delay=".5s">
                        <blockquote>Courageous change; forward-thinking provide; human experience; visionary diversity
                            rights-based approach vaccine, equal opportunity microloans nonviolent.
                        </blockquote>
                        <img src="images/one/t1.jpg" alt="">
    ...
    <div class="bottom-middle-top">
        <div class="container">
            <div class="col-md-6 bottom-grid wow fadeInUp animated animated" data-wow-delay=".5s">
                <h5>NewsLetter</h5>
                <p>Lorem ipsum dolor sit amet, tristique nec libero. Proin vitae convallis odio. Morbi nec enim nisi.
...
<!--copy-right-->
<div class="copy">
    <p class="wow fadeInUp animated animated" data-wow-delay=".5s">Copyright &copy; 2016.Company name All rights
        reserved.More Templates - Collect from </p>
</div>
<!--//copy-right-->
<!--//footer-->
...
<script src="js/one/rAF.js"></script>
<script src="js/one/demo-2.js"></script>
<script src="js/one/main.js"></script> <!-- Resource jQuery -->

<!-- for bootstrap working -->
<script src="js/one/bootstrap.js"></script>
<!-- //for bootstrap working -->
